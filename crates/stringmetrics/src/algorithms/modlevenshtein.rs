...
pub fn levenshtein_limit_weight(
    ...
    levenshtein_limit_weight_iter(a.chars(), b.chars(), limit, w_ins, w_del, w_sub)
}

/// Levenshthein distance computation on strings that split on unicode
///
/// This requires some overhead so is not always desired.
#[inline]
pub fn levenshtein_limit_weight_unicode(
    a: &str,
    b: &str,
    limit: u32,
    w_ins: u32,
...
#[inline]
pub fn levenshtein_quick(a: String, b: String) -> u32 {
